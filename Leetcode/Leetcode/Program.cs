...
//Arrange
//int[] exerciseOne = { 4, 2, 1, 9 };
//int target = 3;

////Act 
//for (int j = 0; j < exerciseOne.Length; j++)
//{
//    for (int i = j+1; i < exerciseOne.Length; i++)
//    {
//        if (exerciseOne[i] + exerciseOne[j]==target)
//        {
...
{ return shipWithinDays(weight, days,)}
